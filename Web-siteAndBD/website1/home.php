...
<div align="center">
  ...
  <h3 style="margin:5px;font-size:18px;"><?php echo "<a href='u/".$_SESSION['username']."'>".$_SESSION['first_name']."".$_SESSION['last_name']."</a>"; if ($_SESSION['verify'] == "1"){echo $verifyUser;} ?></h3>
...
<?php
$mYiD = $_SESSION['id'];
$getS_sql = "SELECT * FROM r_star WHERE favorite =:mYiD ORDER BY id DESC LIMIT 5";
...
while ($getS_row = $getS->fetch(PDO::FETCH_ASSOC)) {
    ...
    $getuser_sql = "SELECT username,userphoto,first_name,last_name FROM signup WHERE id=:getuserid";
    ...
    ?>
    <a href="u/<?php echo $getuser_row['username']; ?>"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/user_imgs/<?php echo $getuser_row['userphoto']; ?>" style="border-radius: 100%;" /> <?php echo $getuser_row['first_name']; ?> <?php echo $getuser_row['last_name']; ?></p></a>
    <?php
    }
}
?>
            ...
            <div class="post">
                ...
                <div class="aSetup" align="center">
                    ...
                    <div class="aSetup_item">
                        <?php
                        $uid = $_SESSION['id'];
                        $sqlQ = "SELECT * FROM follow WHERE reader = :uid";
                        $sqlQ_check = $conn->prepare($sqlQ);
                        $sqlQ_check->bindParam(':uid',$uid,PDO::PARAM_INT);
                        $sqlQ_check->execute();
