...
<div class="dashboard_box" style="text-align: <? echo lang('textAlign'); ?>">
    ...
    <br/>
    <?php
    $fetchUsers_sql = "SELECT username,first_name,last_name,userphoto FROM signup";
    ...
    <table class="dashboard_UsersTable">
        ...
        <td>
            <a href="<?php echo $dircheckPath; ?>u/<?php echo $rows['username']; ?>"><p><?php echo $rows['first_name']; ?></p></a>
			<a href="<?php echo $dircheckPath; ?>u/<?php echo $rows['username']; ?>"><p><?php echo $rows['last_name']; ?></p></a>
        </td>
    ...
    <table class="dashboard_sbFetch">
        ...
        $fetchFrom = $conn->prepare("SELECT first_name,last_name,username FROM signup WHERE id = :from_id");
        $fetchFrom->bindParam(':from_id',$from_id,PDO::PARAM_INT);
        $fetchFrom->execute();
        while ($from_Rows = $fetchFrom->fetch(PDO::FETCH_ASSOC)) {
        $fromid_name = $from_Rows['first_name'];
		$fromid_name2 = $from_Rows['last_name'];
        ...
        <tr>
            ...
            <td><a href="<? echo $dircheckPath.'u/'.$fromid_un; ?>"><? echo $fromid_name; ?><? echo $fromid_name2; ?></a></td>
