...
<head>
    ...
    <div align="center">
        ...
        <!--============[ sign up sec ]============-->
            ...
            <p><input type="text" name="signup_first_name" class="login_signup_textfield" id="fn" placeholder="<? echo lang('first_name'); ?>"/></p>
			<p><input type="text" name="signup_last_name" class="login_signup_textfield" id="ln" placeholder="<? echo lang('last_name'); ?>"/></p>
...
data:{'req':'signup_code','fn':first_name,'ln':last_name,'un':username,'em':emailAdd,'pd':password,'cpd':cpassword,'gr':gender},
beforeSend:function(){
