...
<a href="<?php echo $check_path; ?>u/<?php echo $_SESSION['username']; ?>"><?php echo $_SESSION['first_name']; ?></a><br/>
<a href="<?php echo $check_path; ?>u/<?php echo $_SESSION['username']; ?>"><?php echo $_SESSION['last_name']; ?></a><br/>
