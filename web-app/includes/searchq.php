...
$search_sql = "SELECT * FROM signup WHERE (first_name LIKE ? OR last_name LIKE ? OR country LIKE ?) OR (CONCAT(work,?,work0) LIKE ?) OR username LIKE ? LIMIT 8";
...
<p>$first_name $verify_s<br><span style='font-size: small;'>$under_first_name</span></p>
<p>$last_name $verify_s<br><span style='font-size: small;'>$under_last_name</span></p>
</div>
</a>
</div>";
}
