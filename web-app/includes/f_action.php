...
$fid = "";
$checkfollow_sql = "SELECT * FROM follow WHERE reader=:s_id AND read=:user_id";
...
if ($fchecknum > 0) {
    ...
    $unfollow_sql = "DELETE FROM follow WHERE reader=:s_id AND read=:user_id";
    ...
    $followers_sql = "SELECT id FROM follow WHERE read=:user_id";
