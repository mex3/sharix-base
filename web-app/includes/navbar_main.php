                        ...
                        <li><a href="<?php echo $dircheckPath; ?>u/<?php echo $_SESSION['username']; ?>">
                               <table style="width: 200px; font-size: 15px;">
                                   <tr>
                                       ...
                                       <td style="padding: 0px 5px"><?php echo $_SESSION['first_name']."<br><span style='color: #848484; font-size: 13px;'>@".$_SESSION['username']."</span>"; ?></td>
									   <td style="padding: 0px 5px"><?php echo $_SESSION['last_name']."<br><span style='color: #848484; font-size: 13px;'>@".$_SESSION['username']."</span>"; ?></td>
                                   </tr>
                               </table>
                            </a></li>
                        <?php
