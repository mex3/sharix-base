...
$insert_comment_toDB->execute();
    ...
    while ($query_fetch2 = $query2->fetch(PDO::FETCH_ASSOC)) {
        ...
        $query_fetch_first_name2 = $query_fetch2['first_name'];
		$query_fetch_last_name2 = $query_fetch2['last_name'];
...
<table style='width:100%;margin:5px 0px;' id='comment_$c_id' class='uComment'>
    ...
    </td><td><a class='userLinkComment' href='$uProfileUrl'>$query_fetch_first_name2</a><a class='userLinkComment' href='$uProfileUrl'>$query_fetch_last_name2</a><span>$verifypage_var </span>
